/**
 * Applica 019_accessori_per_categoria.sql
 * Uso: cd web && node scripts/apply-accessori-categoria.mjs
 */
import pg from "pg";
...
const sql = readFileSync(
  join(root, "supabase", "migrations", "019_accessori_per_categoria.sql"),
  "utf8",
);
...
for (const conn of candidates) {
  ...
  try {
    ...
    await client.end();
    console.log("OK migration 019 via", host);
    process.exit(0);
  } catch (e) {
    lastErr = e.message;
