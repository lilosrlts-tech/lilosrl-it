/**
 * Applica migration 018_promozioni_durata.sql
 * Uso: cd web && node scripts/apply-promozioni-migration.mjs
 */
import pg from "pg";
...
const sql = readFileSync(
  join(root, "supabase", "migrations", "018_promozioni_durata.sql"),
  "utf8",
);
...
for (const conn of candidates) {
  ...
  try {
    ...
    await client.end();
    console.log("OK migration 018 applied via", host);
    process.exit(0);
  } catch (e) {
    lastErr = e.message;
