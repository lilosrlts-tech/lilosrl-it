/**
 * Applica migration 017_accessori.sql su Supabase.
 * Uso: cd web && node scripts/apply-accessori-migration.mjs
 */
import pg from "pg";
...
const sql = readFileSync(
  join(root, "supabase", "migrations", "017_accessori.sql"),
  "utf8",
);
...
for (const conn of candidates) {
  ...
  try {
    ...
    await client.end();
    console.log("OK migration 017 applied via", host);
    process.exit(0);
  } catch (e) {
    lastErr = e.message;
