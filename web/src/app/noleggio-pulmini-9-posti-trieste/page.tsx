...
function buildJsonLd() {
  return buildNoleggioHubJsonLd({
    path: "/noleggio-pulmini-9-posti-trieste",
    pageName: META_TITLE,
    pageDescription: META_DESCRIPTION,
    serviceName: "Noleggio pulmini 9 posti a Trieste",
    serviceType: "Noleggio pulmini 9 posti",
    breadcrumbName: "Noleggio pulmini 9 posti Trieste",
    faqItems: FAQ,
  });
}
