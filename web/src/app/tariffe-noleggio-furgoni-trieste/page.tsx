...
import { buildTariffeJsonLd } from "@/lib/json-ld";
...
export default async function TariffePage() {
  ...
  const jsonLd = buildTariffeJsonLd(sezioni);
        ...
        <main className="mx-auto max-w-4xl px-4 py-12">
          <header className="max-w-3xl">
            ...
            <p className="mt-4 leading-relaxed text-slate-600">
              ...
              pagina si aggiorna da sola. I valori sono «a partire da» e possono variare per durata,
              chilometri e disponibilità.
            </p>
          </header>
