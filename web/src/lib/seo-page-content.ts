  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "I cookie analitici e di profilazione, quando presenti, vengono attivati solo dopo una scelta consapevole nel banner (livelli Privato, Equilibrato o Personalizzato). Puoi modificare o revocare il consenso in qualsiasi momento dal link «Preferenze cookie» nel footer. Il titolare del trattamento è LILO S.r.l.; per i dettagli sul trattamento dei dati personali consulta la Privacy Policy collegata in fondo a questa pagina.",
      ],
    },
    {
      h2: "Gestione del consenso, terze parti e diritti dell’interessato",
      paragraphs: [
        "Al primo accesso mostriamo un’informativa sintetica e le opzioni di consenso. Se scegli il livello più riservato, limitiamo l’uso ai cookie necessari. Se abiliti le statistiche, strumenti come Google Analytics possono registrare visite in forma aggregata secondo le impostazioni di consenso. Widget di mappe o social, se presenti, possono impostare cookie di terzi: in quel caso il trattamento segue anche le policy dei rispettivi fornitori.",
