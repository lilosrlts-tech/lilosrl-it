...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl sm:p-8">
        <p className="text-xs font-medium text-slate-400">{hostLabel()}</p>
        <h2
          id="cookie-consent-title"
          className="mt-2 text-center text-lg font-bold leading-snug text-slate-900 sm:text-xl"
        >
          Consideriamo i tuoi dati una tua proprietà e sosteniamo il tuo diritto alla privacy e
          alla trasparenza.
        </h2>
        <p className="mt-3 text-center text-sm leading-relaxed text-slate-600">
          Per offrirvi la migliore esperienza sul nostro sito web, utilizziamo cookie o tecnologie
          simili. Selezionate un livello di accesso ai dati per decidere per quali scopi possiamo
          utilizzare e condividere i vostri dati.
        </p>
        ...
        <p className="mt-5 text-center text-sm leading-relaxed text-slate-600">{copy.description}</p>
